# Print out a string 10 times.  I could have used r10 directly for
...
mainloop:
    ...
    lea msg(%rip), %rsi
    mov $len, %rdx
    mov %rcx, %r10         # preserve rcx which is clobbered by syscall
    syscall
    mov %r10, %rcx         # restore rcx which was clobbered by syscall
    jc err
    loop mainloop
